            ...
            <div class="top-news">
                <div class="about-content">
                    ...
                    <p>Having hands on experience in creating innovative designs, I do offer design
                        ...
                        <label>I do specialize in all aspects of website designing.</label></p>
                    <div class="clearfix"></div>
                    <p class="nam">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores itaque illo ipsam cupiditate omnis delectus illum soluta exercitationem nemo explicabo, sed quo maxime eius quas iusto aut. Molestiae, mollitia ea!</p>
            ...
            <div class="general-inner">
                <div class="edit-pics">
                    ...
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">Ritik raj</a></h5>
                            <div class="td-post-date two"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">Mehak Afreen</a></h5>
                            <div class="td-post-date two"> </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
